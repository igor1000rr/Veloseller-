    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-azure/30 bg-azure/5 p-3 sm:p-4">
        ...
        <ul className="text-sm text-ink-muted space-y-1.5">
          <li>
            <b className="text-ink">Email</b> {t("subs.channels.emailText")} <Link href={"/account" as any} className="text-lime-deep hover:underline">{t("subs.channels.emailLink")}</Link>.
          </li>
          <li>
            <b className="text-ink">Telegram</b> {t("subs.channels.tgText")}
            <Link href={"/account" as any} className="text-lime-deep hover:underline ml-1">{t("subs.channels.tgLink")}</Link>. {t("subs.channels.tgWarn")}
          </li>
        </ul>
