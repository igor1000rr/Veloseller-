...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const entries: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/kalkulyator-tochki-dozakaza`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${SITE_URL}/kalkulyator-yunit-ekonomiki`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
