...
//
// Иконка MAX — вордмарка-плашка (официального SVG-логотипа под рукой нет); если
// появится — заменить на <Icons.Max />. Display-класс (flex/hidden md:flex и т.п.)
// передаётся через className: у корня его нет, чтобы не конфликтовал с `hidden`.
