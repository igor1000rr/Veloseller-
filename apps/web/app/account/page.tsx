  ...
  return (
    <div className="min-h-screen bg-paper text-ink">
      <header className="border-b border-line">
        <div className="max-w-3xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <nav className="flex gap-6 text-sm font-mono uppercase tracking-wider text-ink-hush">
            ...
            <Link href="/billing" className="hover:text-ink">Биллинг</Link>
          </nav>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 space-y-12">
        <section>
          <h1 className="font-display text-4xl tracking-tight">Аккаунт</h1>
          <p className="mt-2 text-ink-hush">Управление данными по GDPR</p>
        </section>
